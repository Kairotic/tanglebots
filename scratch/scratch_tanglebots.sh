...
#sudo pkill -f scratch_tanglebotsGPIO
cd /opt/scratch_tanglebots
sudo python scratch_tanglebotsGPIO.py 127.0.0.1 standard &
scratch --document "/home/pi/Documents/Scratch Projects/tanglebots.sb" 
